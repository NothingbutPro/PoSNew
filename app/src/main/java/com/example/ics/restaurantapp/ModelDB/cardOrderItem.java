...
/**
 * Created by Ics on 5/29/2018.
 */

public class cardOrderItem {
    private String mid,mname;
    private int rate,quantity,totalPrice,SgstTax,CgstTax,IgstTax,totalSgstTax,totalCgstTax,totalIgstTax,Vattax,totalVatTax;

    public cardOrderItem() {
    }

    public cardOrderItem(String mid, String mname, int rate, int quantity, int totalPrice, int sgstTax, int cgstTax, int igstTax, int totalSgstTax, int totalCgstTax, int totalIgstTax, int vattax, int totalVatTax) {
        this.mid = mid;
        this.mname = mname;
        this.rate = rate;
