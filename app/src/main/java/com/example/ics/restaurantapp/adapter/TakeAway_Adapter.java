...
public class TakeAway_Adapter extends RecyclerView.Adapter<TakeAway_Adapter.ViewHolder> {

    private static final String TAG = "TakeAway_Adapter";
    private ArrayList<HashMap<String,String>> takeawaylist;
    ...
    public TakeAway_Adapter(Context mContext, ArrayList<HashMap<String, String>> takeaway_list) {
        context = mContext;
        takeawaylist = takeaway_list;
    }

    @Override
    public TakeAway_Adapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_all_item, parent, false);

        return new TakeAway_Adapter.ViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(final TakeAway_Adapter.ViewHolder viewHolder, int position) {
        final Map<String,String> mMap = takeawaylist.get(position);
